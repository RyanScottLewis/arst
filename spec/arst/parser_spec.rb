describe ARST::Parser do
  ...
  describe '#constant' do
    ...
    it 'should parse correctly' do
      ...
      expect { subject.parse("123") }.to raise_error(ARST::Parser::ParseFailed)
      expect { subject.parse("foo") }.to raise_error(ARST::Parser::ParseFailed)
      expect { subject.parse("_WOAH") }.to raise_error(ARST::Parser::ParseFailed)
    end
    ...
    describe '#namespace' do
      ...
      it 'should parse correctly' do
        ...
        expect { subject.parse("foo") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("_WOAH") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("123::321") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("foo::bar") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("_WOAH::_FOO") }.to raise_error(ARST::Parser::ParseFailed)
      end
    ...
    describe '#module_keyword' do
      ...
      it 'should parse correctly' do
        ...
        expect { subject.parse("module 123") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("module foo") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("module _WOAH") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("module 123::321") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("module foo::bar") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("module _WOAH::_FOO") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("class FooBar") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("class FooBar::BarBaz") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("123") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("foo") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("FOO") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("FOO::BAR") }.to raise_error(ARST::Parser::ParseFailed)
    ...
    describe '#module_keyword' do
      ...
      it 'should parse correctly' do
        ...
        expect { subject.parse("class 123") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("class foo") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("class _WOAH") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("class 123::321") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("class foo::bar") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("class _WOAH::_FOO") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("module FooBar") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("module FooBar::BarBaz") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("123") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("foo") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("FOO") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("FOO::BAR") }.to raise_error(ARST::Parser::ParseFailed)
    ...
    describe '#include_keyword' do
      ...
      it 'should parse correctly' do
        ...
        expect { subject.parse("include 123") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("include foo") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("include _WOAH") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("include 123::321") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("include foo::bar") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("include _WOAH::_FOO") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("extend FooBar") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("extend FooBar::BarBaz") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("123") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("foo") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("FOO") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("FOO::BAR") }.to raise_error(ARST::Parser::ParseFailed)
    ...
    describe '#extend_keyword' do
      ...
      it 'should parse correctly' do
        ...
        expect { subject.parse("extend 123") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("extend foo") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("extend _WOAH") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("extend 123::321") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("extend foo::bar") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("extend _WOAH::_FOO") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("include FooBar") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("include FooBar::BarBaz") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("123") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("foo") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("FOO") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("FOO::BAR") }.to raise_error(ARST::Parser::ParseFailed)
    ...
    describe '#def_keyword' do
      ...
      it 'should parse correctly' do
        ...
        expect { subject.parse("def 123") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("def FOO") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("def 123(foobar=123)") }.to raise_error(ARST::Parser::ParseFailed)
        expect { subject.parse("def FOO(foobar=123)") }.to raise_error(ARST::Parser::ParseFailed)
      end
    ...
    describe '#keyword' do
      ...
      it 'should parse correctly' do
        ...
        expect { subject.parse("    ") }.to raise_error
        expect { subject.parse("\r") }.to raise_error
